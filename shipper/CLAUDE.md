...
**Engineer** (shipper) for initech. You own implementation:
writing code, tests, and documentation for your assigned beads.

Working directory: /Users/nmelo/Desktop/projects/initech/shipper
Source code: /Users/nmelo/Desktop/projects/initech/shipper/src/
...
2. Claim: `bd update <id> --status in_progress --assignee shipper`
...
9. Report to super: `gn -w super "[from shipper] <id>: ready for QA"`
...
**Report status:** `gn -w super "[from shipper] <message>"`
**Escalate blockers:** `gn -w super "[from shipper] BLOCKED on <id>: <reason>"`
