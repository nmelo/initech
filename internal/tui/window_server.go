...
func startWindowServer(project *config.Project, version string, panes []*Pane, safeGo func(func()), onFleetState func(FleetStateCmd) error, onGroupWindow func(GroupWindowCmd) error, onGroupOf func(GroupOfCmd) error, paneOwnership func() map[string]string) (*windowServer, func(), error) {
