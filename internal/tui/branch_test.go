...
func TestTruncateRunes(t *testing.T) {
	cases := []struct {
		...
		{"feat/exactly-twenty-fives", 25, "feat/exactly-twenty-fives"}, // 25 runes — boundary
		{"feat/just-over-twenty-fives", 25, "feat/just-over-twenty-fi…"}, // 27 runes — first truncation
