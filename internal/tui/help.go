...
func getHelpLines() []string {
	helpOnce.Do(func() {
		...
		helpLines = []string{
			...
			"  " + m + "+1            Layout 1 (default focus/1 pane, remap in initech.yaml)",
			"  " + m + "+2            Layout 2 (default 2x1)",
			"  " + m + "+3            Layout 3 (default 3x1)",
			"  " + m + "+4            Layout 4 (default 4x1)",
			"  " + m + "+5            Layout 5 (default 3x2)",
			"  " + m + "+6            Layout 6 (default 4x2)",
			"  " + m + "+7            Layout 7 (default live)",
			"  Shift+" + m + "+1-7    Same preset slot, in live (auto-managed) mode",
			...
			"",
			"Suspended agents",
			"  any key          Wake the focused suspended pane. The keystroke wakes",
			"                   it and is NOT sent to the agent.",
			"  initech resume <agent>   Wake from anywhere; queued messages delivered.",
			"  initech suspend <agent>  Park an idle agent; messages queue until woken.",
			"",
			"Commands  (press ` to open -- main window only)",
